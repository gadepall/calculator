...
\begin{table}[H]
    ...
    \begin{tabular}{@{} l l c @{}}
        ...
        $\arcsin(x)$ & $\sqrt{(1-x^2)}y' - 1 = 0$ & $y(0)=0$ \\
        
        $\arctan(x)$ & $(1+x^2)y' - 1 = 0$ & $y(0)=0$ \\
        $\ln(x)$ & $ xy' - 1 = 0$ & $y(1)=0$ \\
        $e^x$ & $y' - y = 0$ & $y(0)=1$ \\
        $x^w$ & $xy' - wy = 0$ & $y(1)=1$ \\
        \bottomrule
...
\subsection{RK4 for the Sine Function} 
...
The cosine function is computed by $\sin(\frac{\pi}{2} - x)$.\cite{ncert12}



\subsubsection{Tangent Function} 
Tangent is implemented as the ratio of sine and cosine.\cite{ncert12}
...
The ODE for the arcsine function is
ODE: \cite{ncert12}
\begin{align}
...
The ODE for the arctan function is
ODE: \cite{ncert12}
\begin{align}
...
The exponential function $y=\exp(x) = e^x$ satisfies: \cite{ncert12}
\begin{align}
  \frac{dy}{dx} = y, \quad y(0) = 1
\end{align}
\subsubsection{Power Function} 
The power function $y=x^w$ satisfies: \cite{ncert12} 
\begin{align}
...
\begin{enumerate}
  \item \textbf{Pi:} The constant $\pi$ is calculated as $4\cdot\arctan(1)$ using the implementation above. The calculated value is $3.141593$.
  \item \textbf{Euler Constant:} The constant $e$ is calculated as $\exp(1)$ using the implementation above. The calculated value is $2.718282$.
\end{enumerate}

...
As shown in \tabref{tab:hardware_results}, while RK4 does have higher execution times, this is compensated by its performance reaching the hardware peak allowed on the 8 bit microcontroller environment as in \figref{fig:analysis2}.

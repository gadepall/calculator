...
Instead of using ``general expansion methods" (like Taylor/Maclaurin series with many terms), each function was reforumlated as a differential equation.
...
The fourth-order Runge--Kutta (RK4) method \cite{grewal2014,kreyszig2011} is employed to solve ordinary differential equations for trigonometric and exponential functions. This was chosen over alternative numerical integration techniques, keeping in mind the limited resources in a microcontroller based environment. A detailed analysis is given in Appendix~\ref{appendix:comparison}.
